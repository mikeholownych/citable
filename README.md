...
| `schemas/` | 89 JSON Schemas: 29 registries plus findings, determinations, conditions, runs, observations, release governance, remediation verification, the CLI output envelope, config, and prompt results |
