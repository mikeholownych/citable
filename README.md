...
| `schemas/` | 87 JSON Schemas: 29 registries plus findings, determinations, runs, observations, release governance, remediation verification, the CLI output envelope, config, and prompt results |
