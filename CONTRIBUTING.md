...
- Proving a breach of the fail-closed guarantee — see `BOUNTY.md`'s "What
  Qualifies" section for the authoritative scope — follows
  [`BOUNTY.md`](BOUNTY.md), not the general Issue or pull-request path below.
